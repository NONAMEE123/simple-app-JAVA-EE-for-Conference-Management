        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                    <li class="active"><a href="papier_res.jsp"> papier</a></li>
        ...
        <div class="container">
            <div class="row">
              ...
              <a href="papier_res.jsp" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Papier <span class="badge"></span></a>
                <a href="comite_res.jsp" class="list-group-item"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> committe <span class="badge"></span></a>
            ...
            <tr>
               ...
               <td>
                   ...
                   <a href="indexxx.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-success" name="id">Poster</button>
