  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      ...
      <%
       ...
       ps=con.prepareStatement("select * from auteur where username='" + username + "'");
       rs=ps.executeQuery();
       while(rs.next()){
                         %>
    <header id="header">
...
<%
    String first_name, last_name,email,password;
       ...
       if(first_name!=null && last_name!=null && email!=null && username!=null && password!=null ){
           ps=con.prepareStatement("update auteur set first_name='"+first_name+"', last_name='"+last_name+"',email='"+email+"',password='"+password+"'where username='" + username + "'");
           ps.executeUpdate();
