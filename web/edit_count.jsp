<%-- 
    Document   : edit_count
    Created on : 5 janv. 2019, 17:44:38
    Author     : KHALID-RAMI
--%>
  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      ...
      <%
       ...
       ps=con.prepareStatement("select * from admin where id="+id);
       rs=ps.executeQuery();
       while(rs.next()){
                         %>
    <header id="header">
...
<%
    String first_name, last_name,email,username,password;
       ...
       if(first_name!=null && last_name!=null && email!=null && username!=null && password!=null ){
           ps=con.prepareStatement("update admin set first_name='"+first_name+"', last_name='"+last_name+"',email='"+email+"',username='"+username+"',password='"+password+"'where id="+id);
           ps.executeUpdate();
