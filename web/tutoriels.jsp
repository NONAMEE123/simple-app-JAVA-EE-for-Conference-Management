<%-- 
    Document   : tutoriels
    Created on : 5 janv. 2019, 11:44:02
    Author     : KHALID-RAMI
--%>
        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="Message.jsp"> Messages</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                        ...
                        </span> Tutoriels <small> Tutoriels Management </small></h1>
                </div>
                <div class="col-md-2">
    ...
    <section id="main">
        <div class="container">
               ...
               <a href="tutoriels.jsp" class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> tutoriels <span class="badge"></span></a>
                    ...
                    <div class="row">
                            ...
                            <ul class="pager" style="margin-top:0;">
                                <li class="previous" style="cursor:pointer">
                                    <a  href="add_tuto.jsp" type="button"  data-toggle="modal" data-target=".bd-example-modal-lg"><span class="glyphicon glyphicon-plus"> Add Tutoriel</span></a>
                                </li>
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading main-color-bg">
                        </span><h3 class="panel-title"><span class="ion-android-arrow-dropdown" aria-hidden="true"></span> List Of Messages</h3>
                    </div>
            ...
            <tr>
               ...
               <td><c:out value = "${row.decription}"/></td>
               <td><c:out value = "${row.video}"/></td>
           
               <td>
                   <a href="del_tuto.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-danger" name="id">Delete</button>
                                        </td>   
                                </tr>    
                                         </c:forEach>
