  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      ...
      <%
       ...
       ps=con.prepareStatement("select * from participant where id="+id);
       rs=ps.executeQuery();
       while(rs.next()){
                         %>
    <header id="header">
...
<%
    String name,last_name,email,phone_number,adress,username,password;
       ...
       if(name!=null && last_name!=null && email!=null && adress!=null && username!=null && password!=null){
           ps=con.prepareStatement("update participant set name='"+name+"', last_name='"+last_name+"',email='"+email+"',adress='"+adress+"',username='"+username+"',password='"+password+"' where id="+id);
           ps.executeUpdate();
