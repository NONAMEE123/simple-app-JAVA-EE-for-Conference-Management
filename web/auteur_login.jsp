<%-- 
    Document   : auteur_login
    Created on : 8 janv. 2019, 20:47:08
    Author     : KHALID-RAMI
--%>
...
<form action="">
	...
	<fieldset>
            <input  type="text" placeholder="Entrer ton compte" name="cmp" >
		<input type="password" placeholder="Entrer ton mot de passe" name="pwd">
