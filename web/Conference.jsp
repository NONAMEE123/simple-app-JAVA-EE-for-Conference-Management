<%-- 
    Document   : Conference
    Created on : 1 janv. 2019, 19:25:05
    Author     : KHALID-RAMI
--%>
        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="Conference.jsp"> Conference</a></li>
...
<header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                            <h1><span class="ion-android-person-add" aria-hidden="true">
                                 <span class="glyphicon glyphicon-book">
                        </span> Conferences <small> Conferences Management </small></h1>
                </div>
                <div class="col-md-2">
    ...
    <section id="main">
        <div class="container">
               ...
               <a href="tutoriels.jsp" class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> tutoriels <span class="badge"></span></a>
                    ...
                    <div class="row">
                            ...
                            <ul class="pager" style="margin-top:0;">
                                <li class="previous" style="cursor:pointer">
                                    <a  href="add_conf.jsp" type="button"  data-toggle="modal" data-target=".bd-example-modal-lg" onclick=""><span class="glyphicon glyphicon-plus"> Add Conference </span></a>
                                </li>
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading main-color-bg">
                        </span><h3 class="panel-title"><span class="ion-android-arrow-dropdown" aria-hidden="true"></span> List Of Conferences</h3>
                    </div>
            ...
            <tr>
               ...
               <td><c:out value = "${row.date_conf}"/></td>
               <td><c:out value = "${row.location}"/></td>
               <td><c:out value = "${row.description}"/></td>
               <td><c:out value = "${row.date_limite}"/></td>
           
               <td>
                   <a href="edit_conf.jsp?id=${row.id}" type="button" id="sub" class="btn btn-default show_admin" >Edit</button>
                   <a href="del_co.jsp?title=${row.title}" type="button" class="btn btn-danger" name="title">Delete</button>
