        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="session.jsp"> session</a></li>
...
<header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><span class="ion-android-person-add" aria-hidden="true"></span> Session <small> Session Management </small></h1>
                </div>
                <div class="col-md-2">
    ...
    <section class="breadcrumb">
        <div class="container">
            <ol class="breadcrumb" style="padding:0;margin:0;">
                <li class="active">Dashboard / Session</li>
            </ol>
        </div>
    </section>
    ...
    <section id="main">
        <div class="container">
               ...
               <a href="tutoriels.jsp" class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> tutoriels <span class="badge"></span></a>
                    ...
                    <div class="row">
                            ...
                            <ul class="pager" style="margin-top:0;">
                                <li class="previous" style="cursor:pointer">
                                    ...
                                    <a  href="add_session.jsp" type="button"  data-toggle="modal" data-target=".bd-example-modal-lg"><span class="glyphicon glyphicon-plus"> Add Session </span></a>
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading main-color-bg">
                        </span><h3 class="panel-title"><span class="ion-android-arrow-dropdown" aria-hidden="true"></span> List Of Session</h3>
                    </div>
            ...
            <tr>
               ...
               <td><c:out value = "${row.president_name}"/></td>
          <td><c:out value = "${row.comite_name}"/></td>
           
               <td>
                   <a href="edit_session.jsp?id=${row.id}" type="button"  class="btn btn-default show_admin" >Edit</button>
                   <a href="del_session.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-danger" name="id">Delete</button>
                   <a href="detail_papi_pre.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-primary" name="id">Details</button>
