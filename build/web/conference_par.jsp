<%-- 
    Document   : conference_par
    Created on : 10 janv. 2019, 15:08:28
    Author     : KHALID-RAMI
--%>
        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="conference_par.jsp"> Conference</a></li>
                    <li><a href="tutoriels_par.jsp"> tutorials</a></li>
...
<br>
<a href='logout_par.jsp'>Log out</a>
<a href='edit_pai.jsp?username=<%=session.getAttribute("username")%>'>Edit Account</a>
        ...
        <div class="container">
            <div class="row">
             ...
             <a href="papier_par.jsp" class="list-group-item"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Submission <span class="badge"></span></a>
              <a href="conference_par.jsp" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>conference  <span class="badge"></span></a>
               <a href="tutoriels_par.jsp" class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> tutoriels <span class="badge"></span></a>
