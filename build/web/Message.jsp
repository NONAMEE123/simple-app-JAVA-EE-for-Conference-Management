<%-- 
    Document   : Message
    Created on : 2 janv. 2019, 21:00:41
    Author     : KHALID-RAMI
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                        ...
                        </span> Messages <small> Messages Management </small></h1>
                </div>
                <div class="col-md-2">
    ...
    <section id="main">
        <div class="container">
            ...
            <tr>
               ...
               <td>
                   <a href="del_message.jsp?full_name=${row.full_name}" type="button" name="delete_admin_btn" class="btn btn-danger" name="id">Delete</button>
                                        </td>   
                                </tr>    
                                         </c:forEach>
