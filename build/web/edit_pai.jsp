  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      ...
      <%
       ...
       ps=con.prepareStatement("select * from participant where username='" + username + "'");
       rs=ps.executeQuery();
       while(rs.next()){
                         %>
    <header id="header">
          ...
          <div class="col-md-4 col-md-offset-4">
              <form id="login" action="" class="well" method="post">
                  <div class="form-group">
                    ...
                    <label>name</label>
                    <input type="text" name="name"class="form-control" placeholder="Enter Firstname" value="<%= rs.getString("name")%>"/>
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    <label>adress</label>
                    <input type="text" name="adress" class="form-control" placeholder="Enter Email" value="<%= rs.getString("adress")%>"/>
                   </div>
                   <div class="form-group">
...
<%
    String name,last_name,email,phone_number,adress,password;
       ...
       if(name!=null && last_name!=null && email!=null && adress!=null &&  password!=null){
           ps=con.prepareStatement("update participant set name='"+name+"', last_name='"+last_name+"',email='"+email+"',adress='"+adress+"',password='"+password+"' where username='" + username + "'");
           ps.executeUpdate();
           response.sendRedirect("conference_par.jsp");
       }
%>
