<%-- 
    Document   : responsable_int
    Created on : 9 janv. 2019, 20:52:02
    Author     : KHALID-RAMI
--%>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="comite_res.jsp">comite</a></li>
          </ul>
...
<a href='edit_responsable.jsp'>Edit Account</a>
          ...
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="papier_res.jsp" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Papier <span class="badge"></span></a>
               <a href="comite_res.jsp" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Comite <span class="badge"></span></a>
