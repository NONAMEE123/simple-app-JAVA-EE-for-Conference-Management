<%-- 
    Document   : papier
    Created on : 1 janv. 2019, 19:24:10
    Author     : KHALID-RAMI
--%>
        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="papier.jsp"> papier</a></li>
                    <li><a href="Admin.jsp"> Admins</a></li>
...
%>
 <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Papier <small>Papier Managments</small></h1>
          </div>
          <div class="col-md-2">
    ...
    <section id="main">
        <div class="container">
            <div class="row">
              ...
              <a href="Message.jsp" class="list-group-item"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Message <span class="badge"></span></a>
               <a href="tutoriels.jsp" class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> tutoriels <span class="badge"></span></a>
                <a href="comite.jsp" class="list-group-item"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> committee <span class="badge"></span></a>
                    ...
                    <div class="row">
                            ...
                            <ul class="pager" style="margin-top:0;">
                                <li class="previous" style="cursor:pointer">
                                    <form action="/test_jee/newpdf">
                                    <input type="submit"  class="btn-primary" onclick="myFunc()" value="Generate a List Of Participants" />
                                    </form>
            ...
            <tr>
               ...
               <td>
                   <a href="View_file.jsp?id=${row.id}" type="button"  class="btn btn-default show_admin" >View</button>
                   <a href="del_papi.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-danger" name="id">Rejeté</button>
                   <a href="indexx.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-success" name="id">Poster</button>
                   <a href="detail_papi.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-primary" name="id">Details</button>
