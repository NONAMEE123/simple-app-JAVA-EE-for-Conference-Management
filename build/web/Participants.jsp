<%-- 
    ...
    Created on : 1 janv. 2019, 19:24:23
    Author     : KHALID-RAMI
--%>
        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="Participants.jsp"> Participants</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                        ...
                        </span> Participants <small> Participants Management </small></h1>
                </div>
                <div class="col-md-2">
...
<div class="col-md-9">
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading main-color-bg">
                        </span><h3 class="panel-title"><span class="ion-android-arrow-dropdown" aria-hidden="true"></span> List Of Participants
                        </h3>
                    </div>
            ...
            <tr>
               ...
               <td>
                   <a href="edit_par.jsp?id=${row.id}" type="button" id="sub" class="btn btn-default show_admin" >Edit</button>
                   <a href="del_par.jsp?id=${row.id}" type="button" name="delete_admin_btn" class="btn btn-danger" name="id">Delete</button>
